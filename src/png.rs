...
impl Png {
    ...
    pub fn remove_chunk(&mut self, chunk_type: &str) -> Result<Chunk> {
        ...
        return match position {
            Some(p) => Ok(self.chunks.remove(p)),
            None => Err(Error::RemoveChunkError)
        }
    ...
    /// These bytes will contain the header followed by the bytes of all the chunks.
